              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-7">
                        <a href="<?php echo site_url('kependudukan/tambahData')?>" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-plus"></i>Tambah Data Penduduk</a>
                    </div>
                    <form action="<?php echo site_url('kependudukan/cariPenduduk');?>" method = "post">
                      <div class="form-group-row">
                        <div class="col-xs-4">
                          <input type="text" class="form-control" placeholder="Masukkan data penduduk yang dicari" name ="keyword" />
                        </div>
                      </div>
                      ...
                      <thead>
                        <thead>
                          ...
                          <?php }else{
                            ...
                            foreach($kependudukan as $data){ $no;?>
                           <tr height="50px">
                            <td><?php echo $no++?></td>
                            <td><?php echo $data->id_umum?></td>
                            <td><?php echo $data->nama_lengkap?></td>
                            <td><?php echo $data->nomor_induk_kependudukan?></td>
                            ...
                            <td width="250px">
                              <?php echo anchor('kependudukan/edit/'.$data->id_umum,'<button type="button" class="btn btn-info"><i class="glyphicon glyphicon-pencil"></i>Edit Data</button>');?>
                             <?php echo anchor('kependudukan/delete/'.$data->id_umum,'<button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>Hapus Data</button>');?>
                            </td>
                           </tr>
                          <?php }}?>
                          </tbody>
                        ...
                        <thead>
                          ...
                          <?php }else{
                           ...
                           <tr>
                            ...
                            <td><?php echo $data->hubungan_dalam_keluarga?></td>
                            <td><?php echo $data->kewarnegaraan?></td>
                            <td><?php echo $data->nomor_paspor_kitap?></td>
