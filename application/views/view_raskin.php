            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="home/index"><i class="fa fa-home"></i> Home </a>
                  </li>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Data Seluruh Penerima Raskin</h3>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-7">
                        <a href="<?php echo site_url('raskin/tambahData')?>" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-plus"></i>Tambah Data Raskin</a>
                    </div>
                    <form action="<?php echo site_url('raskin/cariRaskin');?>" method = "post">
                      <div class="form-group-row">
                        <div class="col-xs-4">
                          <input type="text" class="form-control" placeholder="Masukkan data penerima yang dicari" name ="keyword" />
                        </div>
                      </div>
                        ...
                        <thead>
                          ...
                          <?php }else{
                           ...
                           <tr height="50px">
                            ...
                            <td width="300px">
                             <?php echo anchor('raskin/edit/'.$data->id_penerima,'<button type="button" class="btn btn-info"><i class="glyphicon glyphicon-pencil"></i>Edit Data</button>');?>
                             <?php echo anchor('raskin/delete/'.$data->id_penerima,'<button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>Hapus Data</button>');?>
                            </td>
                           </tr>
                          <?php }}?>
                          </tbody>
