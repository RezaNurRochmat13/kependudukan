                           ...
                           <tr>
                              ...
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                        <input type="hidden" name="id_umum" value="<?php echo $key->id_umum;?>">
                                      <input type="text" name="nama_lengkap" class="form-control" placeholder="Masukkan nama lengkap" value="<?php echo $key->nama_lengkap; ?>" required>
                                    </div>
                              </div>
                            </div>
                            </td>
                            ...
                            <td>
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                      <input type="text" name="nomor_induk_kependudukan" class="form-control" placeholder="Masukkan nomor induk penduduk" value="<?php echo $key->nomor_induk_kependudukan?>" required>
                                    </div>
                              </div>
                            </div>
                            </td>
                          ...
                          <tr>
                            <td>
                              <div class="form-group=row">
                                ...
                                <div class="col-xs-10">
                                  <div class="right-inner-addon">
                                      <input type="date" name="tanggal_lahir" id="datepicker" class="form-control" placeholder="Masukkan tanggal lahir" value="<?php echo $key->tanggal_lahir ?>" required>
                                </div>
                              </div>
                            </div>
                            </td>
                           ...
                           <tr>
                            <td>
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                      <input type="text" name="tempat_lahir" class="form-control" placeholder="Masukkan tempat lahir" value="<?php echo $key->tempat_lahir?>">
                                    </div>
                              </div>
                            </div>
                            </td>
                           ...
                           <tr>
                            <td>
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                      <input type="text" name="pekerjaan" class="form-control" placeholder="Masukkan pekerjaan" value="<?php echo $key->pekerjaan?>">
                                    </div>
                              </div>
                            </div>
                            </td>
                           ...
                           <tr>
                            <td>
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                      <input type="text" name="nama_kepala_keluarga" class="form-control" placeholder="Masukkan nama kepala keluarga" value="<?php echo $key->nama_kepala_keluarga?>">
                                    </div>
                              </div>
                            </div>
                            </td>
                            ...
                            <td>
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                      <input type="text" name="hubungan_dalam_keluarga" class="form-control" placeholder="Masukkan hubungan dalam keluarga" value="<?php echo $key->hubungan_dalam_keluarga?>">
                                    </div>
                              </div>
                            </div>
                            </td>
                           ...
                           <tr>
                            <td>
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                      <input type="text" name="nomor_paspor_kitap" class="form-control" placeholder="Masukkan nomor paspor atau kitap" value="<?php echo $key->nomor_paspor_kitap?>">
                                    </div>
                              </div>
                            </div>
                            </td>
                           ...
                           <tr>
                            <td>
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                      <input type="text" name="nama_ayah" class="form-control" placeholder="Masukkan nama ayah" value="<?php echo $key->nama_ayah?>">
                                    </div>
                              </div>
                            </div>
                            </td>
                           ...
                           <tr>
                            <td>
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                      <input type="text" name="nama_ibu" class="form-control" placeholder="Masukkan nama ibu" value="<?php echo $key->nama_ibu?>">
                                    </div>
                              </div>
                            </div>
                            </td>
