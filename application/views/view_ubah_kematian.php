            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <?php foreach($edit_kematian as $kematian) { ?>
                     <form action="<?php echo base_url(). 'index.php/kematian/update';?>" method="post">
                              ...
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                        <input type="hidden" name="id_kematian" value="<?php echo $kematian->id_kematian?>">
                                      <input type="text" name="nama_lengkap" class="form-control" placeholder="Masukkan nama lengkap" value="<?php echo $kematian->nama_lengkap ?>" required>
                                    </div>
                              </div>
                            </div>
                            </td>
                          ...
                          <tr>
                            <td>
                              <div class="form-group=row">
                                ...
                                <div class="col-xs-10">
                                  <div class="right-inner-addon">
                                      <input type="date" name="tanggal_lahir" id="datepicker" class="form-control" placeholder="Masukkan tanggal lahir" value="<?php echo $kematian->tanggal_lahir ?>" required>
                                </div>
                              </div>
                            </div>
                            </td>
                           ...
                           <tr>
                            <td>
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                      <input type="text" name="tempat_lahir" class="form-control" placeholder="Masukkan tempat lahir" value="<?php echo $kematian->tempat_lahir?>">
                                    </div>
                              </div>
                            </div>
                            </td>
                           ...
                           <tr>
                            <td>
                              <div class="form-group=row">
                                ...
                                <div class="col-xs-10">
                                  <div class="right-inner-addon">
                                      <input type="date" name="tanggal_meninggal" id="tanggal" class="form-control" placeholder="Masukkan tanggal meninggal" value="<?php echo $kematian->tanggal_meninggal?>" required>
                                </div>
                              </div>
                            </div>
                            </td>
                           ...
                           <tr>
                            <td>
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                      <input type="text" name="tempat_meninggal" class="form-control" placeholder="Masukkan tempat meninggal" value="<?php echo $kematian->tempat_meninggal?>">
                                    </div>
                              </div>
                            </div>
                            </td>
