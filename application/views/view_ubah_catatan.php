            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <?php foreach($edit_catatan as $edit) {?>
                     <form action="<?php echo base_url(). 'index.php/catatan/update';?>" method="post">
                           ...
                           <tr>
                              ...
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                      ...
                                      <input type="text" name="nama_catatan" class="form-control" placeholder="Masukkan nama catatan" value="<?php echo $edit->nama_catatan?>">
                                    </div>
                              </div>
                            </div>
                              </td>
                            ...
                            <td>
                              <div class="form-group-row">
                                  ...
                                  <div class="col-xs-10">
                                    <div class="right-inner-addon">
                                      <input type="text" name="keterangan_catatan" class="form-control" placeholder="Masukkan keterangan catatan" value="<?php echo $edit->keterangan_catatan?>">
                                    </div>
                              </div>
                            </div>
                              </td>
