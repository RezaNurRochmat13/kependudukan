              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="<?php echo site_url('catatan/cariCatatan');?>" method = "post">
                      <div class="form-group-row">
                        <div class="col-xs-4">
                          <input type="text" class="form-control" placeholder="Masukkan catatan yang dicari" name ="keyword" />
                        </div>
                      </div>
                      ...
                      <thead>
                        <thead>
                          ...
                          <?php }else{
                            ...
                            foreach($catatan as $data){ $no;?>
                           <tr height="50px">
                            <td><?php echo $no++?></td>
                            <td><?php echo $data->id_catatan?></td>
                            <td><?php echo $data->nama_catatan?></td>
                            <td><?php echo $data->keterangan_catatan?></td>
                            <td width="300px">
                              <?php echo anchor('catatan/edit/'.$data->id_catatan,'<button type="button" class="btn btn-info"><i class="glyphicon glyphicon-pencil"></i>Edit Data</button>');?>
                             <?php echo anchor('catatan/delete/'.$data->id_catatan,'<button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>Hapus Data</button>');?>
                            </td>
                           </tr>
                          <?php }}?>
                          </tbody>
